(function () {
    ...
    function expression() {
        ...
        expression.injectClassMethods(regex);
    ...
    expression.injectClassMethods = function injectClassMethods(verbalExpression) {

        // Loop over all the prototype methods
        for (var method in expression.prototype) {

            // Make sure this is a local method.
            if (expression.prototype.hasOwnProperty(method)) {

                // Add the method
                verbalExpression[method] = expression.prototype[method];
